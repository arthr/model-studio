            ...
            <div className="flex flex-wrap items-center justify-between w-full">
                <div className="flex items-center">
                    ...
                    {isAuthenticated && (
                        <Button
                            color="transparent"
                            className="p-2 mr-4 text-gray-600 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700"
                    ...
                    <NavbarBrand href="/">
                        <img src="/logo.png" className="mr-3 h-8" alt="Model Studio Logo" />
                        <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Model Studio</span>
                    </NavbarBrand>
                    ...
                    {isAuthenticated && (
                        ...
                        >
                            <DropdownHeader>
                                ...
                                <span className="block truncate text-sm font-medium">usuario@modelstudio.com</span>
                            </DropdownHeader>
